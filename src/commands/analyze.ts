...
Transform this into an optimized Claude prompt that:
1. Opens with a concise project narrative (2-3 sentences max)
...
5. Surfaces any detected gaps the developer should be aware of
6. Ends with a section the developer can fill in: "## What I need help with today:"

Make it feel like a natural briefing, not a data dump. Claude responds better to narrative context than raw file listings.`;

const CHATGPT_USER = (contextDoc: string) => `Here is the raw codebase context document generated by Cliper:

${contextDoc}

Transform this into an optimized ChatGPT prompt that:
